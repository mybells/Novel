            ...
            <div class="book-header" style="height:66px;line-height:66px;text-align:left;display:flex;">
                ...
                <Poptip placement="bottom" width="170">
                    ...
                    <div class="contentStyle" slot="content">
                        <div>
                          <a style="font-size:0.9em" @click="changeSize({fontSize:'0.9em'})"><i class="fa fa-font"></i></a>
                          <a style="font-size:1.2em" @click="changeSize({fontSize:'1.2em'})"><i class="fa fa-font"></i></a>
                          <a style="font-size:1.5em" @click="changeSize({fontSize:'1.5em'})"><i class="fa fa-font"></i></a>
                        </div>
                        <div>
                        ...
                        <div>
                          <a href="javascript:void(0)" @click="changeSize({background:'#fff',color:'#000'})">White</a>
                          <a href="javascript:void(0)" @click="changeSize({background:'#f3eacb',color:'#704214'})">Sepia</a>
                          <a href="javascript:void(0)" @click="changeSize({background:'#1c1f2b',color:'#bdcadb'})">Night</a>
                        </div>
                    </div>
                </Poptip>
